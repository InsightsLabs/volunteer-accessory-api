...
public class LogUtils {
    ...
    public static void logError(Logger log, Exception ex) {
        log.error(ANSI_BOLD + ANSI_RED + "\nException: " + ANSI_UNBOLD + ANSI_RESET + ex.getClass().getSimpleName() + ANSI_RESET +
                ANSI_BOLD + ANSI_BLUE + "\nMotive: " + ANSI_UNBOLD + ANSI_RESET + ex.getMessage() + ANSI_BOLD + ANSI_PURPLE + "\nStacktrace:" + ANSI_UNBOLD + ANSI_RESET, ex);
    }
}
